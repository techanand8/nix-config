                ...
                agent)
                  ...
                  case "''${1:-}" in
                    update)
                      ...
                      nix-shell -p python312 "pipx.overridePythonAttrs (old: { doCheck = false; })" gcc rustc cargo --run "pipx install --python python3.12 --force open-interpreter && pipx runpip open-interpreter install 'setuptools<70'"
